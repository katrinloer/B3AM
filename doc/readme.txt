...
- rdmseed.m for reading miniseed data
- export_fig package for plotting
- Crameri package for scientific colormaps
- CategoricalPalettes (also by Crameri) for categorical scientific colours (batlowS.mat used as default)
